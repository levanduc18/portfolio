...
(function () {
  ...
  var OnePageNav = function () {
    var navToggler = $(".duc-js-nav-toggle");
    $(".smoothscroll[href^='#'], #duc-navbar ul li a[href^='#']").on(
      "click",
      function (e) {
        e.preventDefault();
        var hash = this.hash;
    ...
    $("#duc-navbar ul li a[href^='#']").on("click", function (e) {
  ...
  $(".duc-js-nav-toggle").on("click", function (e) {
    var $this = $(this);
    e.preventDefault();
    if ($("body").hasClass("menu-open")) {
      $this.removeClass("active");
      $(".duc-menu .duc-menu-inner > ul > li").each(function (i) {
        var that = $(this);
        setTimeout(function () {
      ...
      setTimeout(function () {
        $(".duc-menu").removeClass("duc-menu-show");
      }, 800);
      $("body").removeClass("menu-open");
    } else {
      $(".duc-menu").addClass("duc-menu-show");
